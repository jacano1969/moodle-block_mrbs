...
$string['finishedimport']  = 'Processing complete, time taken: {$a->timetaken} seconds'."\n".'{$a->newbookings} New bookings added.'."\n".'{$a->updatedbookings} Bookings updated.'."\n".'{$a->errors} Errors occured.';
...
$string['importerrors'] =   'The following errors were detected:';
$string['importlog']    = 'MRBS Import log';
$string['importline']   = 'on Line {$a}';
$string['importnew']    = '{$a} new bookings created';
$string['importupdated']    = '{$a} bookings updated';
$string['in']                 = 'in';
